...
- **Анализ вопросов** - разбор вопроса и выделение ключевых фактов для поиска
- **Поиск и извлечение данных** из страниц в Википедии через публичное API 
- **Умный поиск** по найденным страницам - разбиение текста на чанки и выбор наиболее подходящих
- **Генерация ответа** с опорой на найденную информацию  
- **Самопроверка** ответа
- **Автоматическая перегенерация** при необходимости  
